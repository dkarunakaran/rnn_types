...
class OneToOneMultiFeatureMultiLayer:
    ...
    def create_model(self):
        ...
        # Here, we need to set return sequence is set to True for multi layer LSTM. Once it is set, output first layer is the input to the next layer. 
...
if __name__== "__main__":
    OneToOneMultiFeatureMultiLayer()